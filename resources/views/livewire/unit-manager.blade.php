<div class="container mx-auto p-4 dark:bg-gray-800 dark:text-gray-200">
    ...
    <form wire:submit.prevent="save" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 dark:bg-gray-700 dark:shadow-lg">
        ...
        <div class="mb-4">
            ...
            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600" id="name" placeholder="Masukkan Nama Unit" wire:model="name">
        ...
        <div class="mb-6">
            ...
            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600" id="short_name" placeholder="Masukkan Nama Singkat (misal: pcs, kg)" wire:model="short_name">
