<div class="container mx-auto p-4 dark:bg-gray-800 dark:text-gray-200">
    ...
    <h2 class="text-2xl font-bold mb-4 dark:text-gray-100">Catat Pembelian Baru</h2>
    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 dark:bg-gray-700">
        <div class="mb-4">
            ...
            <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600" id="supplier_id" wire:model="supplier_id">
        ...
        <h3 class="text-xl font-semibold mb-4 dark:text-gray-100">Tambah Item Pembelian</h3>
    ...
    <button type="button" wire:click="savePurchase()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full md:w-auto dark:bg-blue-600 dark:hover:bg-blue-700">Simpan Pembelian</button>
