<div class="container mx-auto p-4">
    ...
    <h2 class="text-2xl font-bold mb-4">Catat Pembelian Baru</h2>

    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <div class="mb-4">
            <label for="supplier_id" class="block text-gray-700 text-sm font-bold mb-2">Supplier:</label>
            <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="supplier_id" wire:model="supplier_id">
        ...
        <h3 class="text-xl font-semibold mb-4">Tambah Item Pembelian</h3>
