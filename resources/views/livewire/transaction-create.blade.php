<div class="container mx-auto p-4">
    ...
    <h2 class="text-2xl font-bold mb-4">Catat Transaksi Baru</h2>
    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <h3 class="text-xl font-semibold mb-4">Tambah Item Transaksi</h3>
    ...
    @if(count($transaction_items) > 0)
        ...
        <div class="text-right text-2xl font-bold mb-4">Total: {{ number_format($total_price, 2) }}</div>
        <button type="button" wire:click="saveTransaction()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Simpan Transaksi</button>
    @else
