<div class="container mx-auto p-4 dark:bg-gray-800 dark:text-gray-200">
    ...
    <h2 class="text-2xl font-bold mb-4 dark:text-gray-100">Edit Transaksi #{{ $transactionId }}</h2>
    ...
    @if(count($transaction_items) > 0)
        ...
        <button type="button" wire:click="saveTransaction()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full md:w-auto dark:bg-blue-600 dark:hover:bg-blue-700">Update Transaksi</button>
    @else
