                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ $batch->purchase->invoice_number }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ $batch->getOriginal('stock') }}</td> <!-- Assuming original stock is needed -->
                            <td class="px-6 py-4 whitespace-nowrap">{{ $batch->stock }}</td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $batch->expiration_date }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
